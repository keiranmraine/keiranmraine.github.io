...
In 2016 I developed [cgpbox](https://github.com/cancerit/cgpbox) as an initial method of providing our wholegenome analysis platform in a convenient to use form docker image.  This was well received and we continue to build on this with the [dockstore](https://dockstore.org) framework (see above).
